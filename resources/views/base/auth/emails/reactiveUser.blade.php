...
<head>
  ...
  h1 {margin: 10px 0;}
  a {color: #27aa90;text-decoration: none;}
          ...
          <table style="margin:0 auto;" cellspacing="0" cellpadding="0" width="100%">
            <tr>
              <td style="text-align: center;">
                <a href="#"><img class="w320" width="311" src="{{asset('img/medik/Medik-logo.png')}}" alt="company logo" style="padding-top: 20px;" ></a>
              </td>
            </tr>
          </table>
            ...
            <tr>
              ...
              <table cellspacing="0" cellpadding="0" width="100%">
                <tr>
                  ...
                  <br>
                    <strong style="font-size: 1.1em">{{$email}}</strong><br>
                  </td>
                </tr>
              </table>
